    ...
    <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-[#232323]/60 bg-[#0b0b0b]/95 px-4 backdrop-blur-xl sm:h-20 sm:px-6 lg:px-8">
      <div className="flex items-center gap-3 sm:gap-4">
        <details className="relative lg:hidden">
          <summary className="list-none rounded-xl border border-[#2f2f2f] bg-[#131313]/70 p-2.5 text-[#a09a90] hover:border-[#8b5cf6]/30 hover:text-[#e4e4e7]">
        ...
        <div className="hidden h-8 w-1 rounded-full bg-gradient-to-b from-[#8b5cf6] via-[#a78bfa] to-[#7c3aed] sm:block" />
      ...
      <div className="flex items-center gap-2 sm:gap-4">
        {/* Quick Actions */}
        <button className="group hidden rounded-xl border border-[#2f2f2f] bg-[#131313]/70 p-2.5 transition-all duration-300 hover:border-[#8b5cf6]/30 sm:block">
        ...
        <button className="group relative hidden rounded-xl border border-[#2f2f2f] bg-[#131313]/70 p-2.5 transition-all duration-300 hover:border-[#8b5cf6]/30 sm:block">
          <svg className="w-5 h-5 text-[#6b6560] group-hover:text-[#8b5cf6] transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
